...
file1 = 'CU_cyc_q90.out'
file2 = 'CU_cyc_q100.out'
# -----------------------------------------------------------------------------
# Global settings
# -----------------------------------------------------------------------------
height = 6 # cm
...
sp1.plot(eps11, q, color = 'blue', ls='-', lw=0.75, zorder=1, label='$q_{ampl}=90$ kPa')
...
sp1.plot(eps11, q, color = 'red', ls='-', lw=0.75, zorder=1, label='$q_{ampl}=100$ kPa')
...
sp2.plot(p, q, color = 'blue', ls='-', lw=0.75, zorder=1, label='$q_{ampl}=100$ kPa')
...
plt.show()
fig.savefig('triax_CU_cyc.pdf', bbox_inches='tight')
fig.savefig('triax_CU_cyc.png', bbox_inches='tight')