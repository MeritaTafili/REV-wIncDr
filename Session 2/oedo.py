...
file1 = 'output_oed_1_le.out'
file2 = 'output_oed_1_he_c.out'
file3 = 'output_oed_1_he_s.out'
file4 = 'output_oed_E1_he_s.out'
file5 = 'output_oed_S1_he_s.out'
...
# sp1.semilogx(s11, eps11, color = 'blue', ls='-', lw=0.75, zorder=1, label='le')
...
# sp1.semilogx(s11, eps11, color = 'red', ls='-', lw=0.75, zorder=1, label='he_c')
...
sp1.semilogx(s11, eps11, color = 'green', ls='-', lw=0.75, zorder=1, label='he_s')
...
# sp2.semilogx(s11, epor, color = 'red', ls='-', lw=0.75, zorder=1, label='he_c')
# kappa = 0.03
...
sp2.semilogx(s11, epor, color = 'green', ls='-', lw=0.75, zorder=1, label='he_s')
