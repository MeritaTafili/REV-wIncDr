...
file3 = 'output_CD_2_he_c.out'
file4 = 'output_CD_2_he_s.out'
...
sp2.plot(eps11, epsv, color = 'green', ls='-', lw=0.75, zorder=1)     
...
sp2.plot(eps11, epsv, color = 'grey', ls='-', lw=0.75, zorder=1) 
