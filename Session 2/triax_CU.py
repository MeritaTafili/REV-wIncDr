...
file1 = 'output_CU_1.out'
file2 = 'output_CU_2.out'
file3 = 'output_CU_2_he_c.out'
file4 = 'output_CU_2_he_s.out'
# -----------------------------------------------------------------------------
# Global settings
# -----------------------------------------------------------------------------
height = 6 # cm
...
sp1.plot(eps11, q, color = 'blue', ls='-', lw=0.75, zorder=1, label='le_1')
...
sp1.plot(eps11, q, color = 'red', ls='-', lw=0.75, zorder=1, label='le_2')
...
sp1.plot(eps11, q, color = 'green', ls='-', lw=0.75, zorder=1, label='he_c')
...
sp2.plot(p, q, color = 'blue', ls='-', lw=0.75, zorder=1)
...
sp2.plot(p, q, color = 'red', ls='-', lw=0.75, zorder=1)
...
sp2.plot(p, q, color = 'green', ls='-', lw=0.75, zorder=1)  
